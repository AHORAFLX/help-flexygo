...
Each page has a layout where it is possible to add different modules related to the page object information. To do this, it is necessary to access the page, click the Page config tab to the right of the screen and access the Module Manager. In the _image 1_ it is possible to visualize the different layout possibilities that exist for dividing the screen. 
...
![](../docs_assets/images/ModuleManagement/ModuleManagement_2.JPG "Image 1. Display Management Modules")

![](../docs_assets/images/ModuleManagement/ModuleManagement_NewTab.JPG "Image 2. Create new tab")
...
![](../docs_assets/images/ModuleManagement/tabs.PNG "Image 3. Tab type")

![](../docs_assets/images/ModuleManagement/ModuleManagement.png "Image 4. Example of module nesting")
