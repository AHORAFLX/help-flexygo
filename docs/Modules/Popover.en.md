...
<fh-popover class="button margin-right-m" src="/assets/images/Popover/Popover.png" mode="tooltip">Tooltip mode</fh-popover>
<fh-popover class="button margin-right-m" src="/assets/images/Popover/Popover.png" mode="popover">Popover mode</fh-popover>

<fh-popover class="link margin-right-m" src="/assets/images/Popover/Popover.png" mode="tooltip">Tooltip mode</fh-popover>
<fh-popover class="link margin-right-m" src="/assets/images/Popover/Popover.png" mode="popover">Popover mode</fh-popover>
