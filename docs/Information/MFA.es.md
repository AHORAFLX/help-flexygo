...
Implementación del sistema de **Autenticación Multifactor (MFA)**.
...
Recuerda que para usar **MFA por SMS** debes tener configurada la [integración de Abh SMS](../AhoraBusinessHub/AbhSms.md).
{: .flx-warning-card }
