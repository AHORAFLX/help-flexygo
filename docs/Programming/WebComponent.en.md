...
![SQL Feed in grid mode](../docs_assets/images/WebComponent/SQLFeedGrid.png "SQL Feed in grid mode")
...
![SQL Feed in view mode](../docs_assets/images/WebComponent/SQLFeedView.png "SQL Feed in view mode")
