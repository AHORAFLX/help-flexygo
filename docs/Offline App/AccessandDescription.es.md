...
El low code de **flexygo** permite diseñar aplicaciones para dispositivos móviles, de modo que los usuarios puedan trabajar incluso cuando estén sin conexión.

Permite generar una App que se instalará en el dispositivo móvil y se conectará a **flexygo** mediante la Web API, permitiendo el trabajo offline y la sincronización de datos cuando exista conexión. Las sincronizaciones bidireccionales entre el dispositivo y la API actualizarán tanto los datos como el entorno de trabajo.

## Acceso al entorno de Apps Offline

El acceso a la sección de Apps Offline en el entorno de **flexygo** se realiza de la siguiente manera:
