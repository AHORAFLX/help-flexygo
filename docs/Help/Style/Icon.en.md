...
To stack multiple icons, use the **icon-stack** class on the parent, the **icon-stack-1x** for the regularly sized icon, and **icon-stack-2x** for the larger icon. **icon-inverse** can be used as an alternative icon color. You can even throw [larger icon](#larger-icons) classes on the parent to get further control of sizing. Use **icon-stack-right** to stack a smaller icon to the right of a bigger icon.
