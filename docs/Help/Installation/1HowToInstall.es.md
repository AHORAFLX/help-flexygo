...
Para instalar flexygo tan solo tendrás que descargarlo utilizando el botón de abajo y seguir los pasos de instalación, pero antes revisa que cumplas los [requisitos mínimos](#requisitos-minimos):
