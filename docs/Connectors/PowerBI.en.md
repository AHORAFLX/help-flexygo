# Power BI Integration { .fh-title-with-image }
...
Access to the **Reports** section and incorporate your Power BI report introducing the **ReportId** in the report path field.
